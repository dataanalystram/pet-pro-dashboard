...
export default function VetTopbar({ onMenuClick }) {
      ...
      <div className="flex-1 max-w-md hidden sm:block">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-vet-primary/20 focus:border-vet-primary"
          />
        </div>
      </div>

      <div className="flex items-center gap-2 ml-auto">
        <button className="w-9 h-9 rounded-lg flex items-center justify-center hover:bg-slate-100 relative">
        ...
        <div className="relative">
          ...
          >
            <div className="w-8 h-8 rounded-full bg-vet-primary/10 flex items-center justify-center">
